...
- **Context Clue Corroboration**: Compares scraped metadata, display names, and bio tokens to assign a statistical confidence score.
- **Verified Platform Probes**: Asynchronous probing across Social, Developer, Gaming, Media, and Web3 platforms with JSON APIs and rate-limit handling.
...
- **Interactive Relationship Graph**: Force-directed Canvas graph displaying connections between seed targets, handles, emails, and confirmed platforms.
...
│   ├── modules/
│   │   ├── username_probe.py    # Platform probe database & status evaluator
